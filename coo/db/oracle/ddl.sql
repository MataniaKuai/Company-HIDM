...
(
  ...
  update_user_id varchar2(50),
  del_flag integer  DEFAULT 0,
  d_space  VARCHAR2(100),
  w_space  VARCHAR2(100),
  add_coment        VARCHAR2(500)
...
CREATE SEQUENCE T_EQ_Moudule_SEQ 
  INCREMENT BY 1 
  START WITH 1 
  NOMAXvalue 
  NOCYCLE 
...
(
  ...
  update_user_id varchar2(50),
  del_flag integer  DEFAULT 0,
  constraint PK_T_EQ_Moudule primary key (id)
);