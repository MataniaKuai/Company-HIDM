...
public class OPBaseServiceImpl implements OPBaseService {
	...
	public OPBase synchToSap(OPBase opBase) {
         ...
         try {
             ...
             if (success) {
                 ...
                 log.info("EX_WAFERCOSTREWORK::" + exportParameterList.getString("EX_WAFERCOSTREWORK"));
                 opBase.setWaferCostScrap(exportParameterList.getString("EX_WAFERCOSTSCRAP"));
                 log.info("EX_WAFERCOSTSCRAP::" + exportParameterList.getString("EX_WAFERCOSTSCRAP"));
    ...
    public List<OPBase> selectByUserId(Long id) {
        return opBaseDao.selectByUserId(id);
    }
