...
public class ImportReportVo extends ImportInfo {
    ...
    private String taxPrepertyCodeName;
    ...
    private String declaringCustomName;
    ...
    public String getTaxPrepertyCodeName() {
        return taxPrepertyCodeName;
    }

    public void setTaxPrepertyCodeName(String taxPrepertyCodeName) {
        this.taxPrepertyCodeName = taxPrepertyCodeName;
    }
    ...
    public String getDeclaringCustomName() {
        return declaringCustomName;
    }

    public void setDeclaringCustomName(String declaringCustomName) {
        this.declaringCustomName = declaringCustomName;
    }
