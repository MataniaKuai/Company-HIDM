...
public class FilterController {
    ...
    public String logout(String targetURL, HttpServletResponse response, Model model) throws Exception {
    ...
    *@version 1.0
    ...
    @ResponseBody
    public String decodeValue(HttpServletRequest request) throws Exception{
    ...
    public void taskScheduled() {
        for(String key : loginMap.keySet()) {
            ...
            try {
                ...
                log.info("========session过期========" + key);
                loginMap.remove(key);
                ipMap.remove(key);
            }
//            if(sub == null || sub.getSession() == null) {
//                log.info("=========sub.getPrincipal()===========" + sub.getPrincipal());
//            }else {
//                loginMap.remove(key);
//                ipMap.remove(key);
//                log.info("=========sub.getPrincipal()===11========" + sub.getPrincipal());
//            }
        }
    }
